<template>
	<view class="content">
		<form class="app-update-pv">
				...
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">是否离场</view>
				<picker @change="shifoulichangChange" :value="shifoulichangIndex" :range="shifoulichangOptions">
					<view :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.shifoulichang?ruleForm.shifoulichang:"请选择是否离场"}}</view>
				</picker>
			</view>
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				...
				<input :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"110rpx"}' :disabled="ro.xiaoshidanjia" v-model="ruleForm.xiaoshidanjia" placeholder="小时单价"></input>
												...
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">停车时长</view>
				<input :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"110rpx"}' :disabled="ro.tingcheshizhang" v-model="ruleForm.tingcheshizhang" placeholder="停车时长"></input>
			</view>
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				...
				<view :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"110rpx"}' class="right-input">
					{{zongjia}}
												...
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">离场时间</view>
				<input :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"110rpx"}' v-model="ruleForm.lichangshijian" placeholder="离场时间" @tap="toggleTab('lichangshijian')"></input>
			</view>
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
			...
			<view class="btn">
				<button :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,0) inset","backgroundColor":"#409EFF","borderColor":"#409EFF","borderRadius":"8rpx","color":"#fff","borderWidth":"2rpx","width":"160rpx","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' @tap="onSubmitTap" class="bg-red">提交</button>
																																		...
																																		<w-picker mode="dateTime" step="1" :current="false" :hasSecond="false" @confirm="lichangshijianConfirm" ref="lichangshijian" themeColor="#333333"></w-picker>
...
<script>
	...
	export default {
				...
				ruleForm: {
												dingdanbianhao: '',
																...
																userid: '',
																																				...
																																				shifoulichangOptions: [],
				shifoulichangIndex: 0,
																																																																																																				// 登陆用户信息
				user: {},
                                ro:{
		...
		computed: {
						...
						zongjia:{
																																																																																																																							get: function () {
				return 1*this.ruleForm.xiaoshidanjia*this.ruleForm.tingcheshizhang
			}
			},
		...
		async onLoad(options) {
        		this.ruleForm.lichangshijian = this.$utils.getCurDateTime();
			...
			this.user = res.data;
						...
						// ss读取
												...
												this.ruleForm.shangjiaxingming = this.user.shangjiaxingming
																														...
																														// 自定义下拉框值
			this.shifoulichangOptions = "是,否".split(',')
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`lichangshoufei`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='shifoulichang'){
					this.ruleForm.shifoulichang = obj[o];
					this.ro.shifoulichang = true;
					continue;
					}
					if(o=='xiaoshidanjia'){
		...
		methods: {
			...
			// 多级联动参数
																																																			...
																																																			// 日长控件选择日期时间
			lichangshijianConfirm(val) {
				console.log(val)
				this.ruleForm.lichangshijian = val.result;
				this.$forceUpdate();
			},
																																																
																											// 下拉变化
			shifoulichangChange(e) {
				this.shifoulichangIndex = e.target.value
				this.ruleForm.shifoulichang = this.shifoulichangOptions[this.shifoulichangIndex]
			},
			...
			async onSubmitTap() {
					...
					return
																																												...
																																												if(this.ruleForm.tingcheshizhang&&(!this.$validate.isIntNumer(this.ruleForm.tingcheshizhang))){
					this.$utils.msg(`停车时长应输入整数`);
					return
				}
																																																																																																																																																																																																																																																																																																																																																																								if(this.ruleForm.id){
					await this.$api.update(`lichangshoufei`, this.ruleForm);
				}else{
					await this.$api.add(`lichangshoufei`, this.ruleForm);
				}
