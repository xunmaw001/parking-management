<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否取消" prop="shifouquxiao">
          <el-select v-model="ruleForm.shifouquxiao" placeholder="请选择是否取消">
            <el-option
                v-for="(item,index) in shifouquxiaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否取消" prop="shifouquxiao">
	      <el-input v-model="ruleForm.shifouquxiao"
                placeholder="是否取消" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.quxiaoyuanyin = this.ruleForm.quxiaoyuanyin.replace(reg,'../../../ssm6lf25/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
