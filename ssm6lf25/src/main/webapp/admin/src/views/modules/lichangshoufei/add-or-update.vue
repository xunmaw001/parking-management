<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="停车场名称" prop="tingchechangmingcheng">
          <el-input v-model="ruleForm.tingchechangmingcheng" 
              placeholder="停车场名称" clearable  :readonly="ro.tingchechangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="停车场名称" prop="tingchechangmingcheng">
              <el-input v-model="ruleForm.tingchechangmingcheng" 
                placeholder="停车场名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否离场" prop="shifoulichang">
          <el-select v-model="ruleForm.shifoulichang" placeholder="请选择是否离场">
            <el-option
                v-for="(item,index) in shifoulichangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否离场" prop="shifoulichang">
	      <el-input v-model="ruleForm.shifoulichang"
                placeholder="是否离场" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="小时单价" prop="xiaoshidanjia">
          <el-input v-model="ruleForm.xiaoshidanjia" 
              placeholder="小时单价" clearable  :readonly="ro.xiaoshidanjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="小时单价" prop="xiaoshidanjia">
              <el-input v-model="ruleForm.xiaoshidanjia" 
                placeholder="小时单价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="停车时长" prop="tingcheshizhang">
          <el-input v-model="ruleForm.tingcheshizhang" 
              placeholder="停车时长" clearable  :readonly="ro.tingcheshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="停车时长" prop="tingcheshizhang">
              <el-input v-model="ruleForm.tingcheshizhang" 
                placeholder="停车时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="离场时间" prop="lichangshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.lichangshijian" label="离场时间" prop="lichangshijian">
              <el-input v-model="ruleForm.lichangshijian" 
                placeholder="离场时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `lichangshoufei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lichangshoufeiCrossAddOrUpdateFlag = false;
                  this.parent.search();
