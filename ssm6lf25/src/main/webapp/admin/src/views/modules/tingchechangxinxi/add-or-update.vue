<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="容纳车位" prop="rongnachewei">
          <el-input v-model="ruleForm.rongnachewei" 
              placeholder="容纳车位" clearable  :readonly="ro.rongnachewei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="容纳车位" prop="rongnachewei">
              <el-input v-model="ruleForm.rongnachewei" 
                placeholder="容纳车位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实时车位" prop="shishichewei">
          <el-input v-model="ruleForm.shishichewei" 
              placeholder="实时车位" clearable  :readonly="ro.shishichewei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实时车位" prop="shishichewei">
              <el-input v-model="ruleForm.shishichewei" 
                placeholder="实时车位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuangtai = true;
          ...
          if(o=='rongnachewei'){
            this.ruleForm.rongnachewei = obj[o];
	    this.ro.rongnachewei = true;
            continue;
          }
          if(o=='shishichewei'){
            this.ruleForm.shishichewei = obj[o];
	    this.ro.shishichewei = true;
            continue;
          }
          if(o=='keyueshijian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.tingchechangmingcheng!=''&&json.tingchechangmingcheng){
              		this.ruleForm.tingchechangmingcheng = json.tingchechangmingcheng
		}
		if(json.weizhi!=''&&json.weizhi){
              		this.ruleForm.weizhi = json.weizhi
		}
	...
	this.ruleForm.jieshao = this.ruleForm.jieshao.replace(reg,'../../../ssm6lf25/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `tingchechangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tingchechangxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
