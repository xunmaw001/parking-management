<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="进场停车" prop="jinchangtingche">
          <el-select v-model="ruleForm.jinchangtingche" placeholder="请选择进场停车">
            <el-option
                v-for="(item,index) in jinchangtingcheOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="进场停车" prop="jinchangtingche">
	      <el-input v-model="ruleForm.jinchangtingche"
                placeholder="进场停车" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="进场时间" prop="jinchangshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jinchangshijian" label="进场时间" prop="jinchangshijian">
              <el-input v-model="ruleForm.jinchangshijian" 
                placeholder="进场时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jinchangtingche/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jinchangtingcheCrossAddOrUpdateFlag = false;
                  this.parent.search();
